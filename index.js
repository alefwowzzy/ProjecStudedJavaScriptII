    ...
    if (localStorage.getItem("produtos")) {
        ...
        produtos.forEach((produto) => {
            $("#tblProdutos tbody").append(`<tr>
              ...
              <td>${produto.valor}</td>
              <td style="width: 50px">
                  <button type="button" class="btn btn-info" onclick="editarProduto(${produto.id})"><i class="fas fa-pencil-alt"></i></button>
              </td>
              <td style="width: 50px">
                  <button type="button" class="btn btn-danger" onclick="apagarProduto(${produto.id})"><i class="fas fa-trash"></i></button>
               </td>
          </tr>`)
        })
    }
